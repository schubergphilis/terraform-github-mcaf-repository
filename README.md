...
| create\_gitignore | Set to true to create a .gitignore from templates at gitignore.io | `bool` | `false` | no |
...
| gitignore\_io\_templates | List of gitignore.io template names | `list(string)` | <pre>[<br>  "terraform"<br>]</pre> | no |
