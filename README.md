...
| <a name="input_autolink_references"></a> [autolink\_references](#input\_autolink\_references) | Optional map with autolink reference names and their corresponding URL templates | `map(string)` | `{}` | no |
